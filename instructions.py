...
with html:
    tags.p(
        """
        In the main part of this experiment you will be played a series of melodies.
        Your task will be to rate the 'pleasantness' of these melodies on a numeric scale.
        """
    )
